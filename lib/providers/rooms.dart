...
import 'package:rent_a_room/providers/room_filters.dart';
...
class Rooms with ChangeNotifier {
  final List<Room> _items = [
    Room(
      ...
      rent: 1500.0,
      imageUrl:
          'https://www.shutterstock.com/image-photo/modern-design-hotel-hostel-dorm-260nw-1444007420.jpg',
    ...
    Room(
      ...
      rent: 2500.0,
      imageUrl:
          'https://qph.cf2.quoracdn.net/main-qimg-aaf7d00c1aad03c3398687089b335c06-lq',
    ...
    Room(
      ...
      rent: 5000.0,
      imageUrl:
          'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0e/01/e2/98/neat.jpg?w=700&h=-1&s=1',
    ...
    Room(
      ...
      rent: 500.0,
      imageUrl:
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ6JniPbv-sUDivTMuKvN0Futv_Py31xv3V1A&usqp=CAU',
